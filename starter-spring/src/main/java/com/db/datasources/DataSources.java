...
public class DataSources {
    ...
    /*
     * @Bean(destroyMethod = "close") public DataSource getDataSource() { return new
     * JndiDataSourceLookup().getDataSource("java:comp/env/entitlementsDatasource"); }
     */
     ...
     * config.setJdbcUrl("jdbc:hsqldb:file:"+System.getProperty("user.home")+"/db/data"); config.setUsername("sa");
     * config.setPassword(""); return config; }
     */
